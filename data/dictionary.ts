  ...
  fr: {
    ...
    products: {
      ...
      items: [
        { key: "panini", name: "Sandwichs", it: "Sandwich",
          desc: "Des sandwichs généreux préparés à la minute, garnis de nos charcuteries fabriquées sur place, de fromages importés et domestiques et d’ingrédients frais.",
    ...
    panino: {
      ...
      steps: [
        ...
        { no: "03", it: "Il formaggio", text: "La richesse et la douceur de nos fromages." },
  ...
  en: {
    ...
    products: {
      ...
      items: [
        { key: "panini", name: "Sandwiches", it: "Sandwich",
          desc: "Generous sandwiches made to order, layered with our house-made cured meats, imported and domestic cheeses and fresh ingredients.",
    ...
    panino: {
      ...
      steps: [
        ...
        { no: "03", it: "Il formaggio", text: "The richness and softness of our cheeses." },
